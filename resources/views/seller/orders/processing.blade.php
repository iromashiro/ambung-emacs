{{-- resources/views/seller/orders/processing.blade.php --}}
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted">Orders that are being prepared</p>
        </div>
        <div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body text-center py-5">
            ...
            <p class="text-muted">You don't have any orders being processed at the moment.</p>
